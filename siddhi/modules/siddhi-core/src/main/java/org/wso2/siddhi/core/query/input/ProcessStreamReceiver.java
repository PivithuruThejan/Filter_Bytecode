...
public class ProcessStreamReceiver implements StreamJunction.Receiver {
    ...
    protected void processAndClear(ComplexEventChunk<StreamEvent> streamEventChunk) throws InvocationTargetException, IOException, InstantiationException, IllegalAccessException {
