...
public class MultiProcessStreamReceiver extends ProcessStreamReceiver {
    ...
    protected void processAndClear(int processIndex, StreamEvent streamEvent) throws InvocationTargetException, InstantiationException, IllegalAccessException, IOException {
