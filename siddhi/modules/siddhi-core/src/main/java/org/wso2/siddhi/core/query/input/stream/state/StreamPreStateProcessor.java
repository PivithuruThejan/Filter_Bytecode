...
public class StreamPreStateProcessor implements PreStateProcessor, Snapshotable {
    ...
    protected void process(StateEvent stateEvent) throws InvocationTargetException, IOException, InstantiationException, IllegalAccessException {
    ...
    @Override
    public ComplexEventChunk<StateEvent> processAndReturn(ComplexEventChunk complexEventChunk) throws IOException, InstantiationException, IllegalAccessException, InvocationTargetException {
