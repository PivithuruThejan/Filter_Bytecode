...
public class SingleProcessStreamReceiver extends ProcessStreamReceiver {
    ...
    protected void processAndClear(ComplexEventChunk<StreamEvent> streamEventChunk) throws InvocationTargetException, InstantiationException, IllegalAccessException, IOException {
