...
public interface PreStateProcessor extends Processor {
    ...
    ComplexEventChunk processAndReturn(ComplexEventChunk complexEventChunk) throws IOException, InstantiationException, IllegalAccessException, InvocationTargetException;
